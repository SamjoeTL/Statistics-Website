  ...
  <section class="relative mx-auto">
    ...
    <nav class="flex justify-between bg-gray-900 text-white">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        <a class="text-3xl font-bold font-heading" href="{{ route('landingpage') }}">
        ...
        <div class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12 items-center">
                    <x-nav-link :href="route('landingpage')" :active="request()->routeIs('landingpage')" class="text-white hover:text-teal-500">
                        {{ __('Home') }}
                    </x-nav-link>
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-white hover:text-teal-500">
                        {{ __('Book') }}
                    </x-nav-link>
                    <x-nav-link :href="route('promo')" :active="request()->routeIs('promo')" class="text-white hover:text-teal-500">
                        {{ __('Cart') }}
                    </x-nav-link>
