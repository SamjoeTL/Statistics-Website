...
<?php $component->withAttributes([]); ?>
   ...
   <div class="relative w-full overflow-x-auto ">
    ...
    <a href="printdata"><button class="focus:outline-none text-white bg-teal-700 hover:bg-gray-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Export PDF</button></a>
    <a href="printexcel"><button class="focus:outline-none text-white bg-teal-700 hover:bg-gray-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Export EXCEL</button></a>
        <style>
            dialog[open] {
        ...
        <tbody>
            ...
            <td class="px-6 py-4">
                ...
                <td class="px-6 py-4"><a href="admin/<?php echo e($s->id); ?>/edit"><button class="w-16 h-8 text-white bg-yellow-500 rounded-full">Edit</button></a></td>
                <td class="px-6 py-4">
                              ...
                              <div class="flex-row items-center py-4 mx-auto text-center md:flex md:justify-between">
                                <div class="my-4 space-y-2 sm:space-x-2">
                                  <button
                                    ...
                                    Keep it.</button>
                                    <form action="admin/<?php echo e($s->id); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Tegar Folder\Semester 3\Statistik\UAS\resources\views/backpage/admin.blade.php ENDPATH**/ ?>