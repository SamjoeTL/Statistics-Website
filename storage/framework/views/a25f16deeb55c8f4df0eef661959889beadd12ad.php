...
<div class="container flex item-center">
    ...
    <div class="container">
        <h1 class="font-bold text-2xl my-10">Edit Data Tour Guiders</h1>
        <form action="/admin/<?php echo e($guiders->guider_id); ?>" method="POST" enctype="multipart/form-data">
            <?php echo method_field('put'); ?>
            <?php echo csrf_field(); ?>
            <div class="mb-6">
                <label for="id" class="block mb-2 text-sm font-medium text-gray-900">ID</label>
                <input type="text" name="guider_id" id="guider_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-96 p-2.50">
            </div>
            <div class="mb-6">
...
<?php endif; ?><?php /**PATH D:\Tegar Folder\Semester 3\Teknologi Web\uts\resources\views/backpage/edit.blade.php ENDPATH**/ ?>