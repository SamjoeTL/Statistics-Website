                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div class="flex items-baseline justify-between border-b border-gray200 pt-2 pb-6">
                            <h1 class="text-4xl font-bold tracking-tight text-gray900">Book Guide</h1>z
                            
                        </div>
                        <section>
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://world-travel-guy-inboundhorizonsi.netdna-ssl.com/wp-content/uploads/2021/05/DJI_0872.jpg"
                                        alt=""
                                ...
                                <form class="p-6">
                                    <div class="flex flex-wrap">
                                        ...
                                        <div class="w-full flex-none mt-2 order-1 text-3xl fontbold text-teal-500">
                                            Rp.1.000.000
                                        </div>
                                    ...
                                    This beach is located just east of the city of Denpasar, Bali. Sanur is in Denpasar Municipality. Because it has quite calm waves,
                                    Therefore, Sanur is very suitable for resting in peace.
                                    </div>
                                    <div class="flex space-x-4 mb-5 text-sm font-medium">
                                        <div class="flex-auto flex space-x-4">
                                            <a href="promo">
                                                <button class="h-10 px-6 font-semibold rounded-full bg-teal-500 text-white"
                                                type="button">
                                                    Book Now
                                                </button>
                                            </a>
                                        ...
                                        <button
                                            class="flex-none flex items-center justify-center w-9 h9 rounded-full text-teal-600 bg-teal-50"
                            ...
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://mediaim.expedia.com/destination/1/0f42d24364321283d2e7a242ffb50dab.jpg"
                                        alt=""
                                        class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg"
                                        loading="lazy" />
                                </div>
                                <form class="p-6">
                                    ...
                                    <div class="flex items-baseline mt-4 mb-6 pb-6 border-b borderslate-200">
                                    Making this area an attractive and famous tourist spot that must be visited in Bali and one of the best tourist destinations 
                                    on the island of the Gods visited by thousands of tourists both local and international.
                                    </div>
                                    <div class="flex space-x-4 mb-5 text-sm font-medium">
                                        <div class="flex-auto flex space-x-4">
                                            <a href="promo">
...
<?php endif; ?><?php /**PATH D:\Tegar Folder\Semester 3\Teknologi Web\uts\resources\views/dashboard.blade.php ENDPATH**/ ?>